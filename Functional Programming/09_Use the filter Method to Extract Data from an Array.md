...
`Filter` doesn't alter the original array, just like `map`. 
It takes a callback function that applies the logic inside the callback on each element of the array. 
